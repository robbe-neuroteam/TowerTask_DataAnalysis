# This code contains all functions necessary to generate two PDF files per animal after processing.
# !! Not usable yet !! (Maud, 22/02/2025). If you want to generate one PDF (metrics one), please use Generate_PDF_notebook (temporary file)
